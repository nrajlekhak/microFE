...
$ curl http://localhost:8080/authorized -H "Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6Im1hcmlhIiwic3ViIjoyLCJpYXQiOjE2NTAzNjM3OTAsImV4cCI6MTY1MDQ1MDE5MH0.M8LQRgPXRE-FS_mVzAmJuoZOLA9yy7wA4VdNXAPo8KY"
$ # result -> {"userId":2}
```
